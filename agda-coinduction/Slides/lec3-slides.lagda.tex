...
\begin{itemize}
\item Capretta (2005): \emph{General Recursion Via Coinductive Types.}
\item Ghani, Hancock \& Pattinson (2009): \emph{Representations of stream processors using nested fixed points.}
\item Capretta (2013): \emph{Wander types: A formalization of coinduction-recursion}
\item Abel (2016): \emph{Equational Reasoning about Formal Languages in Coalgebraic Style.}
\item Abel \& Pientka (2016): \emph{Well-founded recursion with copatterns and sized types.}
\item Altenkirch, Danielsson \& Kraus (2017): \emph{Partiality, Revisited: The Partiality Monad as a Quotient Inductive-Inductive Type.}
\item Kidney \& Wu (2025): \emph{Formalising Graph Algorithms with Coinduction}
\end{itemize}
\end{frame}
